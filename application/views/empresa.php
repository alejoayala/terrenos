...
<div class="container-fluid" ng-controller="empresaController">
    <div class="row">
        <div class="col-md-12">
            <div class="panel panel-danger" data-widget='{"id" : "wiget10000"}'>
              ...
              <div class="panel-body">
                ...
                <div ui-grid="gridOptions" ui-grid-pagination ui-grid-selection ui-grid-cellNav ui-grid-resize-columns ui-grid-move-columns class="grid table-responsive tableRowDinamic"></div>
              </div>
            </div>
        </div>
    </div>
