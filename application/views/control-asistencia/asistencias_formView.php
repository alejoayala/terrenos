...
<form class="row" name="formControlAsistencia">
...
<div class="modal-footer">
    <button class="btn btn-primary" ng-click="aceptar(); $event.preventDefault();" ng-disabled="formControlAsistencia.$invalid">Aceptar</button>
