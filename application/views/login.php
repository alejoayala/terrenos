<div class="container" id="login-form" ng-controller="loginController">
    <a href="" class="login-logo"><img style="max-width: 365px;" class="img-responsive center-block" masked-image ng-src="{{ dirImages + 'dinamic/empresa/molinera.png' }} "></a>
        <div class="row">
                            ...
                            <div class="form-group mb-md">
                                <div class="col-xs-12">
                                    <div class="input-group">                           
                                        ...
                                        <input ng-model="fLogin.usuario" type="text" class="form-control" placeholder="Usuario" data-parsley-minlength="6" required />
                                    </div>
                                </div>
                            </div>
                            <div class="form-group mb-md">
