...
<div class="modal-body">
    <form class="row"> 
		...
		<div class="form-group mb-md col-md-12">
			<label class="control-label mb-xs">Key Grupo</label>
			<input type="text" class="form-control input-sm" ng-model="fData.keygrupo" placeholder="Registre el Key de Grupo"/>
		</div>
		<div class="form-group mb-md col-md-12">
