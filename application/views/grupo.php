...
<div class="container-fluid" ng-controller="grupoController">
    <div class="row">
        <div class="col-md-12">
            <div class="panel panel-danger" data-widget='{"id" : "wiget10000"}'>
              ...
              <div class="panel-body">
                <ul class="form-group demo-btns">
                    ...
                    <li class="pull-right" ng-if="mySelectionGrid.length == 1"><button type="button" class="btn btn-midnightblue" ng-click='btnAgregarRol()'>Agregar Rol</button></li>
