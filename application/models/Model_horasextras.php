<?php
class Model_horasextras extends CI_Model {
	...
	public function m_cargar_asistencia($paramPaginate){
		...
		$this->db->from('control_horasextras co');
	...
	public function m_count_asistencia()
	{
		...
		$this->db->from('control_horasextras');
		$this->db->where('estado_co <>', 0);
	...
	public function m_registrar($datos)
	{
		...
		return $this->db->insert('control_horasextras', $data);
	}
